            ...
            <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
                <div class="login-register-wrapper">
                    <div class="section-content text-center mb-2">
                        <h3 style="color:black;" class="title-4 mb-2">Reset Password</h3>
                    </div>
                <div class="card-body">
                    ...
                    @if(Session::has('success'))
                            ...
                            @endif
                    <form method="POST" action="{{ route('postReset', ['token' => $user->remember_token]) }}">
                        @csrf
                        <div class="row ">
                        ...
                        <div class="row ">
                            <label for="cpassword" class="col-md-4  ">{{ __('Confirm Password') }}</label>
                        ...
                        <div class="row ">
                            <div class="col-md-8 mx-auto">
                                <button type="submit"name="submit" class="btn flosun-button secondary-btn theme-color rounded-0">
                                  Reset Password
                                </button>
